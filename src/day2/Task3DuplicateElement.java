...
public class Task3DuplicateElement {
    ...
    Create a method that will take ana array of numbers and return all the elements that are duplicates values.

    The result should only include one occurrence of the duplicates

    Ex:

    input : {1, 3 , 5 , 1 , 9 , 5 , 9 , 6 , 4}
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(finDup(1, 3 , 5 , 1 , 9 , 5 , 9 , 6 , 4)));
    }
}
